...
public function listarProductoControlador($pagina,$registros,$url,$busqueda,$categoria){
    ...
    if($total>=1 && $pagina<=$numeroPaginas){
        ...
        foreach($datos as $rows){
            ...
            $nombre_html = htmlspecialchars($rows['producto_nombre'], ENT_QUOTES, 'UTF-8');
            $categoria_html = htmlspecialchars($rows['categoria_nombre'], ENT_QUOTES, 'UTF-8');
            // Usamos number_format para asegurar un formato numérico simple (ej: 12.50)
            $precio = number_format($rows['producto_precio_venta'], 2, '.', ''); 
                ...
                <div class="media-content">
                    ...
                    <div class="has-text-right">
                        ...
                        <button onclick="generarReporteIndividual(
                            ...
                            \''.$nombre_html.'\',
                            '.$precio.',
                            '.$rows['producto_stock_total'].',
                            \''.$categoria_html.'\' 
                        )" 
                        class="button is-link is-rounded is-small" title="Generar Ficha PDF">
