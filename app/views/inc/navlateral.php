<section class="full-width navLateral scroll" id="navLateral">
    ...
    <ul class="full-width menu-principal sub-menu-options">
        <li class="full-width">
            <a href="<?php echo APP_URL; ?>secretaryNew/" class="full-width">
                <div class="navLateral-body-cl">
        ...
        <li class="full-width">
            <a href="<?php echo APP_URL; ?>secretaryList/" class="full-width">
                <div class="navLateral-body-cl">
                    <i class="fas fa-users fa-fw"></i>
                </div>
                <div class="navLateral-body-cr">
    ...
    <ul class="full-width menu-principal sub-menu-options">
        <li class="full-width">
            <a href="<?php echo APP_URL; ?>suppliersNew/" class="full-width">
                <div class="navLateral-body-cl">
                    <i class="fas fa-user-plus fa-fw"></i>
                </div>
                <div class="navLateral-body-cr">
        ...
        <li class="full-width">
            <a href="<?php echo APP_URL; ?>suppliersList/" class="full-width">
                <div class="navLateral-body-cl">
                    <i class="fas fa-address-book fa-fw"></i>
                </div>
                <div class="navLateral-body-cr">
        ...
        <li class="full-width">
            <a href="<?php echo APP_URL; ?>productSupplierNew/" class="full-width">
                <div class="navLateral-body-cl">
                    <i class="fas fa-plus-square fa-fw"></i>
                </div>
                <div class="navLateral-body-cr">
                    Nuevo producto por proveedor
                </div>
            </a>
        </li>
        <li class="full-width">
            <a href="<?php echo APP_URL; ?>productSupplierList/" class="full-width">
                <div class="navLateral-body-cl">
                    <i class="fas fa-boxes fa-fw"></i>
                </div>
                <div class="navLateral-body-cr">
